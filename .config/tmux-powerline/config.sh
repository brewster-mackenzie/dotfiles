...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="brewster"
...
# mailcount.sh {
	...
	#export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/brewster/.mail/inbox/new"
	...
	#export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/brewster/.mailcheckrc"
# }#
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/brewster/.now_playing.log"
